...
(function () {
  ...
  function alertsList(device) {
    ...
    return rowlist([
      ...
      rowitem({ icon: "alert", title: "Forklift license expiring", sub: "Expires Jul 2026 · renew & re-upload", side: badge("expiring"), go: docGo })
    ]);
  }
      ...
      return {
        ...
        ${card(t("common.quickActions"), `
          <div class="choice-row">
            ...
            <button class="choice" data-go="staff/web/documents">${icon("file")} Request document</button>
          </div>`, { icon: "sparkle" })}`
      };
    },
    ...
    "request-new"(param) {
      ...
      return {
        ...
        <div class="grid cols-3">
          ...
          <div style="display:flex;flex-direction:column;gap:14px">
            ${card("Approval chain", steps([{ t: "You", s: "Submit" }, { t: "Khamla S.", s: "L1 · Manager" }, ...(type === "Claim" ? [{ t: "HR / Finance", s: "L2 · Settle" }] : [{ t: "HR", s: "Record & sync" }])], 0), { icon: "layers" })}
    ...
    "request-detail"(id) {
      ...
      return {
        ...
        <div class="grid cols-3">
          ...
          ...(r.type === "Claim" ? [{ t: "HR / Finance · L2", s: "Settle via payroll" }] : [{ t: "HR", s: "Record & sync" }]),
  ...
  const mobile = {
    ...
    "request-detail"(id) {
      ...
      return {
        ...
        ${card("Progress", steps([{ t: "Submitted" }, { t: "L1 · Manager" }, { t: r.type === "Claim" ? "L2 · HR" : "HR record" }, { t: "Done" }], stepIdx), { icon: "layers" })}
    ...
    "request-new"(param) {
      ...
      return {
        ...
        ${card("Chain", steps([{ t: "You" }, { t: "Manager" }, { t: type === "Claim" ? "HR/Fin" : "HR" }], 0), { icon: "layers" })}`
      };
    },
    payslip(id) {
  ...
  PERSONAS.staff = {
    ...
    nav: [
      ...
      { group: "Pay & docs", items: [
        ...
        { id: "documents", icon: "folder", label: t("staff.documents") }
      ]},
      { group: "Account", items: [{ id: "me", icon: "user", label: t("staff.me") }] }
    ],
