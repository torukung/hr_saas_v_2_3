...
window.UI = (function () {
  ...
  function sparkline(values, opts = {}) {
    ...
    return `<svg class="chart" viewBox="0 0 ${w} ${h}" preserveAspectRatio="none" aria-hidden="true">
      <polygon points="${area}" fill="var(--acc-bg)" opacity=".8"/>
  ...
  return { icon, esc, initials, kip, kpi, card, badge, idtag, rowitem, rowlist, table, steps, empty, avatar, sparkline, bars, lines2, donut, heatcal, legend };
})();
